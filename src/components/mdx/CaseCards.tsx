...
export function CaseCards({
  ...
  return (
    <details className="my-8 overflow-hidden rounded-2xl border border-stone-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
      <summary className="cursor-pointer list-none px-5 py-4">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <h3 className="mt-2 text-lg font-semibold text-stone-900 dark:text-white">
              {title}
            </h3>
      ...
      <div className="border-t border-stone-200 px-5 py-5 dark:border-gray-800">
        <div className="grid gap-4 lg:grid-cols-2">
          {cards.map((card) => (
            <div
              key={card.title}
              className="rounded-xl border border-stone-200 bg-stone-50/80 p-4 dark:border-gray-800 dark:bg-gray-950/60"
            >
              ...
              <div className="mt-4 space-y-3 text-sm leading-6">
                <div>
                  ...
                  <p className="mt-1 text-stone-700 dark:text-gray-200">
                    {card.product}
                  </p>
                </div>
                <div>
